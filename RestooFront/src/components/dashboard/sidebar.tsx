  ...
  return (
    <div className="col-lg-3">
      <div className="nav dashboard-sidebar flex-column nav-pills ">
        ...
        <SidebarBtn title="Add Food&Category" link="AddFoodCategory">
          <svg
            width="16"
            height="18"
            viewBox="0 0 16 18"
        ...
        <SidebarBtn title="ViewFood&Category" link="ViewFoodAndCategory">
          <svg
            width="16"
            height="18"
            viewBox="0 0 16 18"
        ...
        <SidebarBtn title="Reservation" link="Reservation">
          <svg
            width="14"
            height="16"
            viewBox="0 0 14 16"
        ...
        <SidebarBtn title="Feedbacks" link="reviews2">
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
